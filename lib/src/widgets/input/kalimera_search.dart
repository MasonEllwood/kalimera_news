...
final key = new GlobalKey<_KalimeraSearchBarState>();

class KalimeraSearchBar extends StatefulWidget{
  ...
  @override
  _KalimeraSearchBarState createState() => _KalimeraSearchBarState();
}

class _KalimeraSearchBarState extends State<KalimeraSearchBar> {
